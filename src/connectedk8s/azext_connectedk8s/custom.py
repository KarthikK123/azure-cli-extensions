...
def create_connectedk8s(cmd, client, resource_group_name, cluster_name, correlation_id=None, https_proxy="", http_proxy="", no_proxy="", proxy_cert="", location=None,
                        ...
                        disable_auto_upgrade=False, cl_oid=None, onboarding_timeout="600", enable_private_link=None, private_link_scope_resource_id=None, enable_namespace_resource=False):
    ...
    utils.helm_install_release(chart_path, subscription_id, kubernetes_distro, kubernetes_infra, resource_group_name, cluster_name,
                               ...
                               custom_locations_oid, helm_client_location, enable_private_link, onboarding_timeout, enable_namespace_resource)
...
def update_agents(cmd, client, resource_group_name, cluster_name, https_proxy="", http_proxy="", no_proxy="", proxy_cert="",
                  disable_proxy=False, kube_config=None, kube_context=None, auto_upgrade=None, tags=None, enable_namespace_resource=False):
    logger.warning("This operation might take a while...\n")
    ...
    if proxy_params_unset and not auto_upgrade and tags is None and not enable_namespace_resource:
